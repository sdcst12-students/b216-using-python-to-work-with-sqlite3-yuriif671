...
#unqiue all to prevent duplicate
cursor.execute('''
CREATE TABLE IF NOT EXISTS games (
    ...
    UNIQUE(home_team, away_team, home_score, away_score)
)
''')

for game in scores:
    cursor.execute(
        "INSERT OR IGNORE INTO games (home_team, away_team, home_score, away_score) VALUES (?, ?, ?, ?)",
